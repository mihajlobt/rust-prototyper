...
layout: default
permalink: /standards/coding/
description: File size, naming, types, styling, Allotment, error handling
---
...
- [Documentation and research](#documentation-and-research)
- [Preserving functionality](#preserving-functionality)
- [Git workflow](#git-workflow)
- [Types](#types)
- [External libraries](#external-libraries)
- [Adherence to approved plans](#adherence-to-approved-plans)
