// Workflow data — node types, palette, and a starter workflow graph.
...
// Starter graph — matches the reference screenshot flow.
const STARTER_NODES = [
...
window.NODE_CATS = NODE_CATS;
window.NODE_LOOKUP = NODE_LOOKUP;
window.STARTER_NODES = STARTER_NODES;
window.STARTER_EDGES = STARTER_EDGES;
window.SAVED_WORKFLOWS = SAVED_WORKFLOWS;
window.LIB_THEMES = LIB_THEMES;
window.LIB_COMPONENTS = LIB_COMPONENTS;
window.LIB_SCREENS = LIB_SCREENS;
window.LIB_APIS = LIB_APIS;
