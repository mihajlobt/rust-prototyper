...
const API_TEMPLATES: Array<Omit<SavedApi, "id" | "history"> & { description: string }> = [
  {
    ...
    description: "Real-time weather. Free key at openweathermap.org → add OPENWEATHERMAP_KEY to Keys",
  },
  {
    name: "OpenWeatherMap — Forecast",
    method: "GET",
    url: "https://api.openweathermap.org/data/2.5/forecast?q=London&cnt=8&appid={{OPENWEATHERMAP_KEY}}",
    headersText: "{}",
    body: "",
    authType: "none",
    authToken: "", authHeaderName: "X-API-Key", authUsername: "", authPassword: "",
    authTokenUrl: "", authClientId: "", authClientSecret: "",
    proxyPath: "/api/weather",
    description: "5-day / 3-hour forecast. Same key as current weather.",
  },
  {
    name: "GitHub — Search Repos",
    method: "GET",
    url: "https://api.github.com/search/repositories?q=react&sort=stars",
    headersText: JSON.stringify({ "User-Agent": "Prototyper", "Accept": "application/vnd.github+json" }, null, 2),
    body: "",
    authType: "none",
    authToken: "", authHeaderName: "X-API-Key", authUsername: "", authPassword: "",
    authTokenUrl: "", authClientId: "", authClientSecret: "",
