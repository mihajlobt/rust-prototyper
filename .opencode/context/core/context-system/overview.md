<!-- Context: core/context-system/overview | Priority: critical | Version: 1.1 | Updated: 2026-06-04 -->
...
**Use when**: Content is repository-specific (e.g., `prototyper/`)
...
**Use for**: Repository-specific context (e.g., `prototyper/`)
