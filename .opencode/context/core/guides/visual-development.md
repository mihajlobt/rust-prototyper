<!-- Context: core/guides/visual-development | Priority: high | Version: 1.1 | Updated: 2026-06-04 -->
...
task(
  ...
  prompt="Context to load:
          - .opencode/context/core/guides/visual-development.md
...
- **Subagent Invocation Guide**: see `core/context-system/guides/navigation-design-basics.md` for cross-agent context loading patterns
- **Agent Capabilities**: see `core/standards/code-quality.md` and `core/workflows/task-delegation-basics.md`
